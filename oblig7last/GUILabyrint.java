...
public class GUILabyrint extends Application {
  ...
  private HBox settNyTopp(){
    ...
    Button resett = new Button("Resett");
      ...
      double buffer = 0;
      if (l.antallRader < 6) buffer = l.antallRader*20;
      else if (l.antallRader < 20) buffer = l.antallRader*36;
      else if (l.antallRader < 30) buffer = l.antallRader*22.3;
      else buffer = l.antallRader*5.5;
